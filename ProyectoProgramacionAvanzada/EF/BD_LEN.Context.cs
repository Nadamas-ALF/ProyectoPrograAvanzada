...
namespace ProyectoProgramacionAvanzada.EF
{
    ...
    public partial class BD_LENEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_Admin_ConsultarPagos_Result> SP_Admin_ConsultarPagos()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Admin_ConsultarPagos_Result>("SP_Admin_ConsultarPagos");
        }
    
        public virtual ObjectResult<SP_Admin_ConsultarResumenPagos_Result> SP_Admin_ConsultarResumenPagos()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Admin_ConsultarResumenPagos_Result>("SP_Admin_ConsultarResumenPagos");
        }
    }
}
